...
<body>
    ...
    <script>
        ...
        const CONFIG = {
            ...
            // 👤 THÔNG TIN CÁ NHÂN
            // ═══════════════════════════════════════════════════════════════════
            avatar: "https://www.facebook.com/tuanh.nguyenha.2906/",                         // Avatar (emoji hoặc link ảnh)
            statusBadge: "😢",                     // Badge trạng thái bên cạnh avatar
            authorName: "Tú Em",                    // Tên hiển thị ở footer
            ...
            storyContent: `
                <p>Xin chào, tôi là một <span class="highlight">sinh viên UET</span> đang loay hoay giữa cuộc sống, ôn thi XSTK đến 1h sáng, học bài đến <span class="highlight">hói đầu</span>, và <span class="highlight">thâm mắt</span>. Nhưng tôi cũng cần được yêu thương! 💔</p>
                <p>Mỗi đồng bạn donate sẽ giúp tôi:</p>
                <ul style="margin-top: 10px; margin-left: 20px;">
                    <li>🍜 Ăn gà lotte thay vì mì gói</li>
                    <li>☕ Mua cà phê sữa để ngủ ngon hơn vì uống xong no quá </li>
                    <li>💊 Mua thuốc nhỏ mắt (quan trọng!)</li>
                    <li>🎮 Thỉnh thoảng được đi chơi</li>
                </ul>
            `,
            ...
            // ═══════════════════════════════════════════════════════════════════
            marqueeItems: [
                "🔥 BREAKING: Bỏ ăn trưa 7 ngày liên tục để làm bài tập XSTK này!",
                "🎮 Fun fact: 99% donate sẽ đi vào bụng tôi (mostly lotte)",
                "📊 Thống kê: 420 người xem, 69 người cười, 0 người donate",
                "☕ Đang cần gấp gà lotte để có sức lướt tiktok (review phim)",
                "🏆 TOP DONOR: Anonymous - 500k | Lời nhắn: \"Học ít thôi, ăn đi em\"",
            ],
            ...
            donationOptions: [
                {
                    amount: 12000,
                    emoji: "🫓",
                    description: "1 bánh bao thập cẩm ăn sáng",
                },
                {
                    amount: 35000,
                    emoji: "🍜",
            ...
            BIDV Fallback: "https://q.me-qr.com/f/donateoday",
            ...
            recentDonations: [
                ...
                // {
                //     avatar: "😇",                           // Emoji avatar
                //     name: "UETot",            // Tên người donate
                //     message: "Đồng cảm với UETer! 💪",  // Lời nhắn
                //     amount: 100000,                         // Số tiền (không có dấu phẩy)
                //     time: "2025-12-14 08:30:00"            // Thời gian (YYYY-MM-DD HH:MM:SS)
                // },
            ],
